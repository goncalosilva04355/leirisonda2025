...
function App() {
  ...
  try {
    ...
    useEffect(() => {
      ...
      // Verificar se imports essenciais estão dispon��veis
      try {
    ...
    useEffect(() => {
      ...
      if (document.readyState === "complete") {
        ...
        return () =>
          window.removeEventListener("load", detectFirebaseConflicts);
      }
    }, []);
    ...
    const isWorkAssignedToCurrentUser = (work: any) => {
      ...
      if (
        ...
        work.assignedUserIds.includes(currentUser.id)
      ) {
        return true;
      }
    ...
    useEffect(() => {
      const loadSettings = () => {
        try {
          ...
          const savedPhoneDialer =
            safeLocalStorage.getItem("enablePhoneDialer");
      ...
      const initAutoSync = async () => {
        ...
        if (isFirestoreReady()) {
          ...
          try {
            ...
            console.error(
              "�� Erro ao iniciar sincronização automática:",
              error,
            );
...
© ${new Date().getFullYear()} Leirisonda - Sistema de Gestão
    `;
      downloadPDF(
        content,
        `Obras_${new Date().toISOString().split("T")[0]}.pdf`,
      );
    };
                        ...
                        <div className="space-y-3 max-h-96 overflow-y-auto">
                          ...
                          clients.length === 0 ? (
                            <div className="text-center py-8">
                              ...
                              <p className="text-gray-400 text-xs mt-1">
                                Adicione obras, piscinas, manutenções ou
                                clientes primeiro
                              </p>
                            </div>
                          ) : (
                              ...
                              {works.filter(
                                ...
                                clients.filter(
                                  ...
                                  <div className="text-center py-8">
                                    ...
                                    <p className="text-gray-400 text-xs mt-1">
                                      Tente pesquisar por cliente, obra,
                                      piscina, data ou técnico
                                    </p>
                                  </div>
                                )}
                            </>
                        ...
                        <div className="space-y-4">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-600 mb-2">
                              ...
                              Utilizadores inativos sao marcados como
                              "(Inativo)".
                            </p>
                                ...
                                onClick={() => {
                                  if (currentAssignedUser) {
                                    const selectedUser = users.find(
                                      (u) =>
                                        String(u.id) === currentAssignedUser,
                                    );
                          ...
                          onClick={async (e) => {
                            ...
                            const workData = {
                              ...
                              type: (() => {
                                ...
                                if (workType === "instalacao")
                                  return "montagem"; // Map instalacao to montagem
                        ...
                        {safeActiveConfigTab === "configuracoes" && (
                          <div className="space-y-6">
                            ...
                            <div className="bg-white rounded-lg p-6 shadow-sm">
                              ...
                              <p className="text-gray-600 mb-6">
                                Configure o comportamento de cliques em
                                contactos e moradas
                              </p>
                                  ...
                                  <div className="flex items-start space-x-3">
                                    ...
                                    <div className="flex-1">
                                      ...
                                      <p className="text-green-700 text-sm mb-3">
                                        Quando ativado, clicar numa morada
                                        abrirá o Google Maps para navegação.
                                      </p>
                                ...
                                <div className="space-y-4">
                                  <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
                                    ...
                                    <p className="text-purple-700 text-sm mb-3">
                                      Acesso às configurações avançadas do
                                      sistema
                                    </p>
                                    <button
                                      onClick={() => {
                      ...
                      <div className="flex space-x-4 pt-6 border-t border-gray-200">
                        ...
                        <button
                          ...
                          onClick={async (e) => {
                            ...
                            const client = (inputs[2] as HTMLInputElement)
                              .value; // Cliente
                            const contact = (inputs[3] as HTMLInputElement)
                              .value; // Contacto
                            const location = (inputs[4] as HTMLInputElement)
                              .value; // Morada
                            const startTime = (inputs[5] as HTMLInputElement)
                              .value; // Hora de Entrada
                            const endTime = (inputs[6] as HTMLInputElement)
                              .value; // Hora de Saída
                            const status = (inputs[7] as HTMLSelectElement)
                              .value; // Estado
                    ...
                    <form className="space-y-6">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                          ...
                          <select
                            defaultValue={
                              editingPool?.filtrationSystem || "sand"
                            }
                            className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                          >
                      ...
                      <div className="flex space-x-4">
                        ...
                        <button
                          ...
                          onClick={(e) => {
                            ...
                            const materialsUsed = (
                              inputs[9] as HTMLInputElement
                            ).value; // Materiais Utilizados
                            const observations = (
                              inputs[10] as HTMLInputElement
                            ).value; // Observaç€s
        ...
        return (
          <div className="min-h-screen bg-gray-50 flex items-center justify-center">
            <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
              ...
              <form
                onSubmit={handleAdvancedPasswordSubmit}
                className="space-y-4"
              >
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center p-8">
          ...
          <div style={{ opacity: 0.8 }}>
            A aplicação encontrou um erro inesperado. Por favor, recarregue a
            página.
          </div>
          <button
            onClick={() => window.location.reload()}
