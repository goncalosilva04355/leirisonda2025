...
function App() {
  ...
  // SISTEMA SIMPLES - usar os dados do hook simplificado
  ...
  const futureMaintenance = dataSync.futureMaintenance || [];
  const isDataLoading = dataSync.isLoading || false;
  ...
  // Estados da UI - manter tudo igual
  ...
  const [personalLocationSettings, setPersonalLocationSettings] =
    useState(false);
        ...
        <div className="min-h-screen bg-gray-50">
          ...
          <div className="lg:pl-80">
            ...
            <div className="p-6">
              ...
              {/* Placeholder para outras secções */}
              {activeSection !== "dashboard" && (
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-600 mb-4">
                    A tua aplicação original está de volta! Sistema simplificado
                    implementado.
                  </p>
